...
// AVX512 (halves converted to fp32 via vcvtph2ps). Returns -dot(a, b) so
// that callers can derive cosine distance as 1 + ip.
void inner_product_fp16_distance_avx512(const void *a, const void *b,
                                        size_t dim, float *distance);

// Batch version of inner_product_fp16_distance_avx512.
