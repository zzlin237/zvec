...
class QuantizeType:
    ...
    PQ: typing.ClassVar[QuantizeType]  # value = <QuantizeType.PQ: 5>
    PQ_FAST: typing.ClassVar[QuantizeType]  # value = <QuantizeType.PQ_FAST: 6>
    ...
    ]  # value = {'UNDEFINED': <QuantizeType.UNDEFINED: 0>, 'FP16': <QuantizeType.FP16: 1>, 'INT8': <QuantizeType.INT8: 2>, 'INT4': <QuantizeType.INT4: 3>, 'RABITQ': <QuantizeType.RABITQ: 4>, 'PQ': <QuantizeType.PQ: 5>, 'PQ_FAST': <QuantizeType.PQ_FAST: 6>}
